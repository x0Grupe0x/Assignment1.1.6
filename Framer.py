...
class Tenno(pygame.sprite.Sprite):
    def __init__(self) -> None:
        super().__init__()
        self.image = pygame.image.load("Images\Tenno.png").convert_alpha()
